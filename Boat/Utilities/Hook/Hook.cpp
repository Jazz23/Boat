...
namespace Hook
{
	void __fastcall __HOOKS::EmplaceHook(size_t pktId, void (*in_f)(uintptr_t))
	{
	...
	void __fastcall __HOOKS::Fire(size_t pktId, uintptr_t pkt)
	{
	...
	bool __fastcall __HOOKS::IsHooked(size_t pktId)
	{
		if (pktId < setSize)
